...
# from rag_retrieval import rag_add_context  # Import the RAG function
from web_search import websearch_add_context
...
class ConsoleAssistant:
    ...
    def generate_response(self, user_input: str):
        enhanced_input = websearch_add_context(user_input)
        
        self._messages.append({"role": "user", "content": enhanced_input})
...
def main():
    ...
    config_path = "./glados_config.yml"  # Replace with your actual config path
